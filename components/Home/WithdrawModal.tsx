...
const ADD_BALANCE = gql`
    mutation Mutation($accountId: String!, $amount: Float!) {
        withdrawBalance(accountId: $accountId, amount: $amount) {
            balance
            id
            name
            desc
...
const WithdrawModal = () => {
    ...
    const [withdrawBalance, { data: mData, loading: mLoading, error: mError }] =
        useMutation(ADD_BALANCE, {
            update(cache, { data: { withdrawBalance } }) {
                cache.modify({
                    fields: {
